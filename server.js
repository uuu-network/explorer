...
(function(){
  let createModule, modules, api, responsity, app;
  ...
  */
  ...
  moduleNames = ['account', 'wallet', 'transaction', 'onekeytoken', 'browse', 'questionaries', 'rapiddeployment', 'tube', 'proposal', 'ipfsupload']
  modules = {}
